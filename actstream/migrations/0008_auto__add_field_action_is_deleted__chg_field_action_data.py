...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Action.is_deleted'
        db.add_column(u'actstream_action', 'is_deleted',
    ...
    def backwards(self, orm):
        # Deleting field 'Action.is_deleted'
        db.delete_column(u'actstream_action', 'is_deleted')
